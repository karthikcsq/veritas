  ...
  return (
    <div className="h-dvh max-h-dvh flex flex-col overflow-hidden fixed inset-0 bg-black">
      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        {/* Globe — positioned absolutely, anchored to bottom */}
        <div className="absolute inset-x-0 bottom-0 flex justify-center pointer-events-none" style={{ top: "28%", zIndex: 20 }}>
          <div className="pointer-events-auto">
            <GlobeWrapper />
          </div>
        </div>

        {/* Top text — buttons + heading: above everything */}
        <div className="relative z-[40] flex flex-col items-center px-6 text-center pointer-events-none">
          <div className="pt-10 pb-4 w-full flex flex-col items-center"
            style={{ background: "linear-gradient(to bottom, black 50%, transparent 100%)" }}
          >
            <div className="max-w-3xl space-y-5 pointer-events-auto">
              <div className="flex items-center justify-center gap-3 pb-6 opacity-0 animate-[fadeSlideUp_1.2s_ease-out_1.4s_forwards]">
                <button
              ...
              <h1
                className="text-5xl sm:text-7xl font-bold tracking-tight text-white opacity-0 animate-[fadeSlideUp_1.2s_ease-out_1.6s_forwards]"
              >
        ...
        {/* Description — above globe (z-25), below panels (z-35) */}
        <div className="relative z-[25] flex justify-center px-6 text-center -mt-2">
          <p
            className="text-base sm:text-lg text-white/50 max-w-xl mx-auto leading-relaxed opacity-0 animate-[fadeSlideUp_1.2s_ease-out_2.0s_forwards]"
          >
